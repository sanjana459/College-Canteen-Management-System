...
<head>
    ...
    <title>Welcome | JSS Cafeteria</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to JSS Cafeteria</h1>
            <p class="lead fw-normal">Food ordering system of JSSATE-B Campus Canteen</p>
            <span class="xsmall-font text-muted"></span>
        </div>
    </div>

    <div class="container p-5" id="recommended-shop">
        <h2 class="border-bottom pb-2"><i class="bi bi-shop align-top"></i> Recommended</h2>
