...
<head>
    ...
    <title>Shop List | JSS Cafeteria</title>
</head>
    ...
    <div class="container pt-2" id="cust-table">
        ...
        <?php
            if(!isset($_GET["search"])){
                $search_query = "SELECT s_id,s_name,s_location,s_openhour,s_closehour,s_status,s_preorderstatus,s_phoneno FROM shop;";
            }else{
                $search_un=$_GET["un"];
                $search_sn=$_GET["sn"];
                $search_query = "SELECT s_id,s_name,s_location,s_openhour,s_closehour,s_status,s_preorderstatus,s_phoneno FROM shop
        ...
        <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="small"><br/><?php echo "(+91) ".$row["s_phoneno"];?></td>
                    <td>
